...
public class AVLTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    /**
     * check if tree is balanced, if not do rotations needed to fix it
     * @param t root node
     * @return the balanced tree root with updated heights
     * */
    // Assume t is either balanced or within one of being balanced
    private AvlNode<AnyType> balance( AvlNode<AnyType> t ) {
        if( t == null )
            return t;
        // check for imbalances between left and right children that need right rotations
        if( height( t.left ) - height( t.right ) > ALLOWED_IMBALANCE ) {
            // rotate as needed to fix imbalance
            ...
            // check for imbalances between left and right children that require left rotations
        } else if( height( t.right ) - height( t.left ) > ALLOWED_IMBALANCE ) {
            // rotate as needed to fix
    ...
    /**
     * check the balance of the tree rooted at a certain node
     * */
    ...
    /**
     * check the balance of a tree and either return the height or an error message
     * @param t root node
    ...
    private AvlNode<AnyType> deleteMin( AvlNode<AnyType> t ) {
        ...
        if (t.left != null) {
            ...
            // update address and height at each level
            ...
            // if lowest value is not leaf and has a right child
            // right child becomes new lowest node after t is deleted
        } else if (t.right != null){
            t = t.right;
        } else {
            t = null;
     ...
     * @param t node rotation is rooted in
    ...
    /**
     * create and format the building blocks of AVL trees
     * */
